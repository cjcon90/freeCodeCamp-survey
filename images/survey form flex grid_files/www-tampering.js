...
var v=u(this);function w(a,b){if(b){for(var c=v,g=a.split("."),h=0;h<g.length-1;h++){var k=g[h];k in c||(c[k]={});c=c[k]}g=g[g.length-1];h=c[g];k=b(h);k!=h&&null!=k&&r(c,g,{configurable:!0,writable:!0,value:k})}}
...
v.Symbol||(v.Symbol=A)}
function B(a,b){this.a=a;r(this,"description",{configurable:!0,writable:!0,value:b})}
B.prototype.toString=function(){return this.a};
var A=function(){function a(c){if(this instanceof a)throw new TypeError("Symbol is not a constructor");return new B("jscomp_symbol_"+(c||"")+"_"+b++,c)}
var b=0;return a}();
function C(){z();var a=v.Symbol.iterator;a||(a=v.Symbol.iterator=v.Symbol("Symbol.iterator"));"function"!=typeof Array.prototype[a]&&r(Array.prototype,a,{configurable:!0,writable:!0,value:function(){return D(n(this))}});
C=function(){}}
function D(a){C();a={next:a};a[v.Symbol.iterator]=function(){return this};
return a}
w("WeakMap",function(a){function b(d){this.a=(f+=Math.random()+1).toString();if(d){d=p(d);for(var e;!(e=d.next()).done;)e=e.value,this.set(e[0],e[1])}}
function c(){}
function g(d){var e=typeof d;return"object"===e&&null!==d||"function"===e}
function h(d){if(!y(d,m)){var e=new c;r(d,m,{value:e})}}
...
var m="$jscomp_hidden_"+Math.random();k("freeze");k("preventExtensions");k("seal");var f=0;b.prototype.set=function(d,e){if(!g(d))throw Error("Invalid WeakMap key");h(d);if(!y(d,m))throw Error("WeakMap key fail: "+d);d[m][this.a]=e;return this};
b.prototype.get=function(d){return g(d)&&y(d,m)?d[m][this.a]:void 0};
b.prototype.has=function(d){return g(d)&&y(d,m)&&y(d[m],this.a)};
b.prototype["delete"]=function(d){return g(d)&&y(d,m)&&y(d[m],this.a)?delete d[m][this.a]:!1};
return b});
w("Map",function(a){function b(){var f={};return f.previous=f.next=f.head=f}
function c(f,d){var e=f.a;return D(function(){if(e){for(;e.head!=f.a;)e=e.previous;for(;e.next!=e.head;)return e=e.next,{done:!1,value:d(e)};e=null}return{done:!0,value:void 0}})}
function g(f,d){var e=d&&typeof d;"object"==e||"function"==e?k.has(d)?e=k.get(d):(e=""+ ++m,k.set(d,e)):e="p_"+d;var l=f.f[e];if(l&&y(f.f,e))for(var t=0;t<l.length;t++){var x=l[t];if(d!==d&&x.key!==x.key||d===x.key)return{id:e,list:l,index:t,b:x}}return{id:e,list:l,index:-1,b:void 0}}
...
C();var k=new WeakMap;h.prototype.set=function(f,d){f=0===f?0:f;var e=g(this,f);e.list||(e.list=this.f[e.id]=[]);e.b?e.b.value=d:(e.b={next:this.a,previous:this.a.previous,head:this.a,key:f,value:d},e.list.push(e.b),this.a.previous.next=e.b,this.a.previous=e.b,this.size++);return this};
...
w("Set",function(a){function b(c){this.a=new Map;if(c){c=p(c);for(var g;!(g=c.next()).done;)this.add(g.value)}this.size=this.a.size}
...
C();b.prototype.add=function(c){c=0===c?0:c;this.a.set(c,c);this.size=this.a.size;return this};
...
function V(){var a=new Set;[].concat(q(document.querySelectorAll("script"))).forEach(function(b){b.src&&!T(b.src)&&a.add(b.src)});
[].concat(q(document.querySelectorAll("link[href]"))).forEach(function(b){"alternate"==b.rel||T(b.href)||a.add(b.href)});
return[].concat(q(a)).sort()}
function W(){var a=new Set;[].concat(q(document.querySelectorAll("script"))).forEach(function(b){b.src&&(b=U(b.src))&&a.add(b)});
return[].concat(q(a)).sort()}
function X(){var a=new Set;[].concat(q(window.document.querySelectorAll("*"))).forEach(function(b){[].concat(q(b.classList)).forEach(function(c){Y()||a.add(c)})});
return a}
